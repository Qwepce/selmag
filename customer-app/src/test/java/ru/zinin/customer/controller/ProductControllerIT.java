...
class ProductControllerIT {
    ...
    void getProductPage_ProductExists_ReturnsProductPage() {
        ...
        stubFor(get("/feedback-api/product-reviews/by-product-id/1")
                .willReturn(okJson("""
                        [
                            {
                                "id": "79479cdb-3fa1-4eaa-842e-00bc4645d9f3",
                                "productId": 1,
                                "rating": 5,
                            ...
                            },
                            {
                                ...
                                "rating": 5,
                                "review": "Отличный товар",
                                "userId": "289d4540-6bc4-44c3-8e9b-916422c7ea83"
                            }
                        ]""")
                        .withHeader(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)));
        stubFor(get("/feedback-api/favourite-products/by-product-id/1")
                .willReturn(created()
                        ...
                        .withBody("""
                                {
                                    "id": "67bf6d7e-61fe-4464-ad6c-f1438e241bb8",
                                    "productId": 1
                                }""")));
        //when
        this.webTestClient
    ...
    @Test
    void getProductPage_UserIsNotAuthenticated_RedirectsToLoginPage() {
        //given
    ...
    void addProductToFavourites_RequestIsValid_ReturnsRedirectionToProductPage() {
        ...
        WireMock.stubFor(WireMock.post("/feedback-api/favourite-products")
                ...
                .willReturn(WireMock.created()
                        ...
                        .withBody("""
                                {
                                    "id": "aef45b20-2fa6-4399-9c20-806d87293c94",
                                    "productId": 1
                                }""")));
    ...
    @Test
    void removeProductFromFavourites_ProductDoesNotExist_ReturnsNotFound() {
        //given
        stubFor(delete("/feedback-api/favourite-products/by-product-id/404")
                .willReturn(notFound()));
        //when
        this.webTestClient
                .mutateWith(mockUser())
    ...
    @Test
    void removeProductFromFavourites_UserIsUnauthorized_RedirectsToLoginPage() {
        //given
                        ...
                        .withBody("""
                                {
                                    ...
                                    "rating": 3,
                                    "review": "Ну, на троечку",
                                    "userId": "1b745d0a-98a2-4ce4-83e9-7cd057d73c8e"
                                }""")));
        //when
        this.webTestClient
                .mutateWith(mockUser())
    ...
    void createReview_RequestIsInvalid_ReturnsProductPage() throws Exception {
                ...
                .withRequestBody(equalToJson("""
                        {
                            "productId": 1,
                            "rating": -1,
                            "review": "Очень длинный отзыв > 1000 символов"
                        }"""))
        ...
        this.webTestClient
                ...
                .body(BodyInserters.fromFormData("rating", "-1")
                        .with("review", "Очень длинный отзыв > 1000 символов"))
                //then
                .exchange()
    ...
    @Test
    void createReview_UserIsUnauthorized_RedirectsToLoginPage() {
        //given
